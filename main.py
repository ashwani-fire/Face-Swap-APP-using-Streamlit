...
st.title("F[A]ce Sw[A]p")
st.markdown("Upload an image of person 1")

#Uploading the dog image
img = st.file_uploader("Choose an image...", type=["png","jpg","jpeg"])
img2 = st.file_uploader("Choose an image...", type=["png","jpg"])
...
if img and img2:
    ...
    st.image(seamlessclone, caption=None, width=None, use_column_width=None, clamp=False, channels="BGR", output_format="auto")
